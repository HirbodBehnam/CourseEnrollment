...
type CourseEnrollmentServerServiceClient interface {
	...
	GetStudentsInCourse(ctx context.Context, in *StudentsOfCourseRequest, opts ...grpc.CallOption) (*StudentsOfCourseResponse, error)
...
func (c *courseEnrollmentServerServiceClient) GetStudentsInCourse(ctx context.Context, in *StudentsOfCourseRequest, opts ...grpc.CallOption) (*StudentsOfCourseResponse, error) {
	out := new(StudentsOfCourseResponse)
	err := c.cc.Invoke(ctx, "/proto.CourseEnrollmentServerService/GetStudentsInCourse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseEnrollmentServerServiceClient) ForceEnroll(ctx context.Context, in *StudentEnrollRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.CourseEnrollmentServerService/ForceEnroll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseEnrollmentServerServiceClient) ForceDisenroll(ctx context.Context, in *StudentDisenrollRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.CourseEnrollmentServerService/ForceDisenroll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseEnrollmentServerServiceServer interface {
	...
	// This method will list students registered in a course
	GetStudentsInCourse(context.Context, *StudentsOfCourseRequest) (*StudentsOfCourseResponse, error)
	// This endpoint must forcibly register a user in a course, add capacity if needed
...
func _CourseEnrollmentServerService_GetStudentsInCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentsOfCourseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseEnrollmentServerServiceServer).GetStudentsInCourse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CourseEnrollmentServerService/GetStudentsInCourse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseEnrollmentServerServiceServer).GetStudentsInCourse(ctx, req.(*StudentsOfCourseRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CourseEnrollmentServerService_ForceEnroll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentEnrollRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseEnrollmentServerServiceServer).ForceEnroll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CourseEnrollmentServerService/ForceEnroll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseEnrollmentServerServiceServer).ForceEnroll(ctx, req.(*StudentEnrollRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CourseEnrollmentServerService_ForceDisenroll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentDisenrollRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseEnrollmentServerServiceServer).ForceDisenroll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CourseEnrollmentServerService/ForceDisenroll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseEnrollmentServerServiceServer).ForceDisenroll(ctx, req.(*StudentDisenrollRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseEnrollmentServerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStudentsInCourse",
			Handler:    _CourseEnrollmentServerService_GetStudentsInCourse_Handler,
		},
		{
			MethodName: "ForceEnroll",
			Handler:    _CourseEnrollmentServerService_ForceEnroll_Handler,
		},
		{
